  ...
  <el-dialog v-model="visible" :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form :model="dataForm" :rules="rules" ref="dataFormRef" @keyup.enter="dataFormSubmitHandle()" label-width="120px">
        ...
        <el-input v-model="dataForm.type" placeholder="动漫类型"></el-input>
          ...
          <el-form-item label="动漫封面图片url" prop="imageUrl">
        <el-input v-model="dataForm.imageUrl" placeholder="动漫封面图片url"></el-input>
      </el-form-item>
          <el-form-item label="动漫发布日期(范围)" prop="aired">
        <el-input v-model="dataForm.aired" placeholder="动漫发布日期(范围)"></el-input>
      </el-form-item>
        ...
        <el-input v-model="dataForm.status" placeholder="动漫状态"></el-input>
          ...
          <el-form-item label="动漫来源(小说、漫画..." prop="source">
        <el-input v-model="dataForm.source" placeholder="动漫来源(小说、漫画..."></el-input>
      </el-form-item>
        ...
        <el-input v-model="dataForm.rank" placeholder="动漫排名"></el-input>
      </el-form-item>
...
const dataForm = reactive({
  id: '',  name: '',  genres: '',  synopsis: '',  type: '',  imageUrl: '',  aired: '',  episodes: '',  score: '',  producers: '',  studios: '',  director: '',  premiered: '',  status: '',  source: '',  duration: '',  rating: '',  rank: '',  popularity: '',  favorites: '',  scoredBy: '',  members: ''});
